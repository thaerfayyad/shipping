    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{__('company/config.packages.create')}}</h4>
                    </div>
                    <hr>
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input name="length" type="text" class="form-control" id="length" required>
                                </div>
                            </div>
                                <div class="form-group row">
                                    <label for="width" class="col-sm-2 text-right control-label col-form-label">{{__('company/config.packages.width')}}</label>
                                    <div class="col-sm-6">
                                        <input name="width" type="text" class="form-control" id="width" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="form-group row">
                                     <label for="weight" class="col-sm-2 text-right control-label col-form-label">{{__('company/config.packages.weight')}}</label>
                                            <div class="input-group col-sm-6">
                                                <input name="weight" type="text" class="form-control" id="weight" style="height: 42px;" required>
                                                <div class="input-group-append">
                                                    @if(LaravelLocalization::setLocale()=='ar')
                                                    <select class="form-control" id="select2-theme" style="height: 42px;" name="type_ar">
                                                        <option value="كيلوغرام">{{__('company/config.packages.kg')}}</option>
                                                        <option value="طن">{{__('company/config.packages.ton')}}</option>
                                                    </select>
                                                    @else
                                                        <select class="form-control" id="select2-theme" style="height: 42px;" name="type_en">
                                                            <option value="kg">{{__('company/config.packages.kg')}}</option>
                                                            <option value="ton">{{__('company/config.packages.ton')}}</option>
                                                        </select>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            @if(LaravelLocalization::setLocale()=='ar')
                            <div class="form-group row">
                                <label for="" class="col-sm-6 text-right control-label col-form-label" style="color: red">{{__('company/config.packages.note')}}</label>
                            </div>
                                @else
                                <div class="form-group row">
                                    <label for="" class="col-sm-10 text-right control-label col-form-label" style="color: red">{{__('company/config.packages.note')}}</label>
                                </div>
                            @endif
                        </div>
