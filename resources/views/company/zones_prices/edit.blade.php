    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{__('company/config.zones.edit')}}</h4>
                    </div>
                    <hr>
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('zones.update',$zone->id)}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="name_ar" class="col-sm-2 text-right control-label col-form-label">{{__('company/config.zones.name')}}</label>
                                <div class="col-sm-6">
                                    <input name="name_ar" type="text" class="form-control" id="name_ar" value="{{$zone->name_ar}}">
                                </div>
                            </div>


                            <div class="form-group row">
                                <label for="name_en" class="col-sm-2 text-right control-label col-form-label">{{__('company/config.zones.name_en')}}</label>
                                <div class="col-sm-6">
                                    <input name="name_en" type="text" class="form-control" id="name_en" value="{{$zone->name_en}}">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group m-b-0 text-right">
                                ...
                                <a href="{{route('zones.index')}}" class="btn btn-dark waves-effect waves-light">{{__('config.cancel')}}</a>
                            </div>
                        </div>
                    </form>
                </div>
