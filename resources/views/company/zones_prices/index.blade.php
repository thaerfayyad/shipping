...
{{--                                            <form action="{{route('packages.destroy',$val->PackageID)}}" method="post">--}}
{{--                                                <input class="btn btn-default" type="submit" /><i class="fas fa-trash-alt"></i>--}}
{{--                                                @method('delete')--}}
{{--                                                @csrf--}}
{{--                                            </form>--}}
                                            <a href="{{route('zones.destroy',$val->id)}}" class="btn btn-danger waves-effect waves-light"><i class="fas fa-trash-alt"></i></a></td>
                                        <td>{{$val->name_ar}}</td>
                                        <td>{{$val->name_en}}</td>
