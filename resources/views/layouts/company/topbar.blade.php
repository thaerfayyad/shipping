                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            <div class="">
                                <img src=" {{asset('storage/avatars/')}}/{{\Auth::user()->UserInfo->avatar}}" alt="user" class="img-circle" width="60">
                            </div>
                            <div class="m-l-10">
                          ...
                          <a class="dropdown-item" href="{{url(LaravelLocalization::setLocale().'/company/profile/'.\Auth::user()->UserID.'/edit')}}">
                       ...
                       <!--  <a class="dropdown-item" href="javascript:void(0)">
                        ...
                        <div class="p-l-30 p-10">
                            <a href="{{url(LaravelLocalization::setLocale().'/company/profile/'.\Auth::user()->UserID.'/edit')}}" class="btn btn-sm btn-success btn-rounded">{{__('dashboard.View Profile')}}</a>
                        </div>
