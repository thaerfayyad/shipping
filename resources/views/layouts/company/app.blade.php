...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('website/assets/logo.png')}}">
    <!-- Title -->
@if(LaravelLocalization::setLocale()=='ar')
...
@if(LaravelLocalization::setLocale()=='ar')
 ...
 <link href="{{asset('website/assets/css/rtl.css')}}" rel="stylesheet">
 @endif
...
@include('layouts.company.customizer-panel')
