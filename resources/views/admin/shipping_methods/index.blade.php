    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">{{ __('admin/config.shipping.title') }}</h2>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('admin/config.shipping.id')}}</th>
                                    <th>{{__('admin/config.shipping.actions')}}</th>
                                    <th>{{__('admin/config.shipping.name')}}</th>
                                    <th>{{__('admin/config.shipping.name_en')}}</th>
                                ...
                                @foreach ($shipping_methods as $key => $val)
                                    <tr>
                                        ...
                                        <td>{{$key+1}}</td>
                                        <td>
                                            <a href="{{url(LaravelLocalization::setLocale().'/admin/shipping-methods/'.$val->id.'/edit')}}" class="btn btn-info waves-effect waves-light"><i class="fas fa-edit"></i></a>

                                        <form action="{{ route('shipping-methods.destroy',$val->id) }}" method="post" class="form-check-inline" >
                                                    @csrf
                                                    {{ method_field('DELETE') }}
