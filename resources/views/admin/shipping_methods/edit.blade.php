    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{__('admin/config.shipping.edit')}}</h4>
                    </div>
                    <hr>
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('shipping-methods.update',$shipping_method->id)}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="title_ar" class="col-sm-2 text-right control-label col-form-label">{{__('admin/config.shipping.name')}}</label>
                                <div class="col-sm-6">
                                    <input name="title_ar" type="text" class="form-control" id="title_ar" value="{{$shipping_method->title_ar}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input name="title_en" type="text" class="form-control" id="title_en" value="{{$shipping_method->title_en}}">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group m-b-0 text-right">
                                ...
                                <a href="{{route('shipping-methods.index')}}" class="btn btn-dark waves-effect waves-light">{{__('config.cancel')}}</a>
                            </div>
                        </div>
                    </form>
                </div>
