            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h2 class="card-title">{{ __('company/config.title') }}</h2>
                        <br>
                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                @foreach ($orders as $key => $val)
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{url(LaravelLocalization::setLocale().'/admin/orders/'.$val->id.'/edit')}}" class="btn btn-info waves-effect waves-light"><i class="fas fa-edit"></i></a>
