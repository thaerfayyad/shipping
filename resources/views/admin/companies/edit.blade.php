    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-10">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{__('company/config.edit')}}</h4>
                    </div>
                    <hr>
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('companies.update',$company->CompanyID)}}">
                        {{method_field('PATCH')}}
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="name" value="{{$company->UserInfo->user->name}}" name="name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="email" class="form-control" id="email" name="email"value="{{$company->UserInfo->user->email}}" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="mobile" value="{{$company->UserInfo->mobile}}" pattern=".{2,}" required >
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="address" name="address" value="{{$company->UserInfo->address}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="facebook" value="{{$company->UserInfo->facebook}}" >
                                            <p class="help-block wow tada" style="font-size: 15px">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="twitter" name="twitter" value="{{$company->UserInfo->twitter}}" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                     <textarea rows="5" class="form-control form-control-line" name="about" id="about">{{$company->UserInfo->about}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-sm-12 col-lg-6">
                        ...
                        @endif
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="register_no" name="register_no" value="{{$company->register_no}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
