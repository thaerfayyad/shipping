            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h2 class="card-title">{{ __('admin/service.title') }}</h2>
                        <div class="table-responsive">
                            ...
                            <table id="file_export" class="table table-striped table-bordered display">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('admin/service.create.img')}}</th>
                                    <th>{{__('admin/service.create.title')}}</th>
                                    <th>{{__('admin/service.create.label')}}</th>
                                    <th>{{__('admin/service.create.des_ar')}}</th>
                                    <th>{{__('admin/service.create.des_en')}}</th>
...
{{--                                    <th>{{__('admin/member.config.name_en')}}</th>--}}
                                ...
                                @foreach ($services as $key => $val)
                                    <tr>
                                        ...
                                        <td>{{$key+1}}</td>
                                        <td>
                                            <a href="{{url(LaravelLocalization::setLocale().'/admin/services/'.$val->id.'/edit')}}" class="btn btn-info waves-effect waves-light"><i class="fas fa-edit"></i></a>
                                             <form action="{{ route('services.destroy',$val->id) }}" method="post" class="form-check-inline" >
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                        ...
                                        <td>
                                            <img src="/storage/img/{{$val->img}}" alt="{{$val->title}}"  class="rounded-circle" width="55">
                                        </td>
                                        <td>{{@$val->title}}</td>
                                        <td>{{@$val->label}}</td>
                                        <td>{{@$val->des_ar}}</td>
